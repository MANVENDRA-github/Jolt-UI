...
3. **Determinism:** animations are tested by _seeking_ to a frame or asserting the reduced-motion final state — never by wall-clock timing, `Date.now()`, or randomness in assertions.
